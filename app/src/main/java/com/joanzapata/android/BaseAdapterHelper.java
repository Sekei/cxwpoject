...
public class BaseAdapterHelper {
	 ...
	 * @return
	 */
	public BaseAdapterHelper setCompoundDrawablesWithIntrinsicBounds(int viewId, int left, int top, int right,
			int bottom) {
		TextView view = retrieveView(viewId);
	 ...
	 * @return
	 */
	public BaseAdapterHelper setImageBackground(int viewId, int drawable) {
		ImageView view = retrieveView(viewId);
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, DisplayImageOptions option) {
		ImageView view = retrieveView(viewId);
		ImageLoader.displayImage(imageUrl, view, option);
		return this;
	}
	...
	/**
	 * 单独实例化控件,并适配控件LinearLayout/RelativeLayout
	 */
	public BaseAdapterHelper setImageViewLinearLayout(int viewId, int Height, int Width) {
		View view = retrieveView(viewId);
	 ...
	 * 防止多次实例化计算控件影响体验流程度
	 */
	public BaseAdapterHelper setImageViewRelativeLayout(int viewId, int Height, int Width) {
