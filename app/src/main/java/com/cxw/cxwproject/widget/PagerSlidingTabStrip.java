...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabPadding = 0;// 这里设置距离可以实现跟今日头条一样的效果
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		indicatorColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_pstsIndicatorColor1,
				indicatorColor);

		// tab文字选中时的颜色,默认和滑动指示器的颜色一致
		selectedTabTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_selectedTabTextColor1,
				indicatorColor);

		underlineColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_pstsUnderlineColor1,
				underlineColor);
		dividerColor = a
				.getColor(R.styleable.PagerSlidingTabStrip_pstsDividerColor1,
						dividerColor);
		indicatorHeight = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight1,
				indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight1,
				underlineHeight);
		dividerPadding = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsDividerPadding1,
				dividerPadding);
		tabPadding = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight1,
				tabPadding);
		tabBackgroundResId = a.getResourceId(
				R.styleable.PagerSlidingTabStrip_pstsTabBackground1,
				tabBackgroundResId);
		shouldExpand = a
				.getBoolean(R.styleable.PagerSlidingTabStrip_pstsShouldExpand1,
						shouldExpand);
		scrollOffset = a
				.getDimensionPixelSize(
						R.styleable.PagerSlidingTabStrip_pstsScrollOffset1,
						scrollOffset);
		textAllCaps = a.getBoolean(
				R.styleable.PagerSlidingTabStrip_pstsTextAllCaps1, textAllCaps);
