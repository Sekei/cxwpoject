...
import com.cxw.cxwproject.view.loading.LoadingView;
...
public class EmptyLayout extends LinearLayout implements android.view.View.OnClickListener, ILoadView {
	...
	public static int SOURCE = 0;// 标示不同页面来源显示不同提示
	...
	private TextView tv, tv_error_btn;// 提示文字---提示点击按钮
	...
	private void init() {
		...
		animProgress = (LoadingView) view.findViewById(R.id.animProgress);
	...
	public void setErrorType(int i) {
		...
		case NODATA:
			...
			img.setBackgroundResource(R.drawable.pagefailed_bg);// page_icon_empty
			img.setVisibility(View.VISIBLE);
			tv.setVisibility(View.VISIBLE);
			tv_error_btn.setVisibility(View.VISIBLE);
			animProgress.setVisibility(View.GONE);
			...
			break;
		case HIDE_LAYOUT:
			// animProgress.LoadingStop();// 停止动画效果
			setVisibility(View.GONE);
			break;
