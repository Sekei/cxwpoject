		...
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				if (index == currentIndex) {
					textView.setTextColor(context.getResources().getColor(R.color.uli_bg));
					textView.setTextSize(maxsize);
				} else {
					textView.setTextColor(context.getResources().getColor(R.color.uli_797979));
