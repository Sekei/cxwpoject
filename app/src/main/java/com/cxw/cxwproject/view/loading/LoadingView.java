...
public class LoadingView extends FrameLayout {
	...
	private TextViewLoadView mLoadView;// 绘画字体
	...
	protected void onFinishInflate() {
		...
		mLoadView = (TextViewLoadView) view.findViewById(R.id.id_loadView);
		...
		this.postDelayed(new Runnable() {
			...
			public void run() {
				...
				freeFall();
				/**
				 * 使用情形1：LoadingView 第一参数：执行时间，设置变色执行的时间
				 * 第二个参数：是否循环重新变色，true循环变色，并且重头开始变色
				 * 第三个参数：是否反向褪色，true则表示变色完成之后反向褪色
				 */
				mLoadView.start(1500, true, true);
			}
		}, 250);
