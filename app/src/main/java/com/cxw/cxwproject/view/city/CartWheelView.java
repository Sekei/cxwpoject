 ...
 */
public class CartWheelView extends View {
	 ...
	 * Constructor
	 */
	public CartWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public CartWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public CartWheelView(Context context) {
		super(context);
		initData(context);
	}
