...
public class UploadUtil {
	 ...
	 *            请求的URL
	 */
	public void uploadFile(Context context, String filePath, String fileKey, String RequestURL,
	...
	private void toUploadFile(File file, String fileKey, String RequestURL, Map<String, String> param) {
		...
		try {
			...
			if (res == 200) {
				...
				result = sb1.toString();
				String jsonData = new String(result.getBytes("iso8859-1"));
				System.out.println("上传结果:" + jsonData);
				try {
					JSONObject arr=new JSONObject(jsonData);
					sendMessage(UPLOAD_SUCCESS_CODE, arr.getString("data"));
