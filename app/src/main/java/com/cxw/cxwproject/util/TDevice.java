...
import com.cxw.cxwproject.util.mvc.ILoadView;
...
public class TDevice {
	...
	public static final boolean hasCamera() {
		if (_hasCamera == null) {
			PackageManager pckMgr = getContext().getPackageManager();
	...
	public static boolean isPackageExist(String pckName) {
		try {
			PackageInfo pckInfo = getContext().getPackageManager().getPackageInfo(pckName, 0);
			if (pckInfo != null)
				return true;
	...
	public static void showSoftKeyboard(View view) {
		((InputMethodManager) getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).showSoftInput(view,
				InputMethodManager.SHOW_FORCED);
	}

	public static void toogleSoftKeyboard(View view) {
		((InputMethodManager) getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(0,
	...
	public static boolean isZhCN() {
		String lang = getContext().getResources().getConfiguration().locale.getCountry();
	...
	public static PackageInfo getPackageInfo(String pckName) {
		try {
			return getContext().getPackageManager().getPackageInfo(pckName, 0);
		} catch (NameNotFoundException e) {
	...
	public static String getVersionName() {
		String name = "";
		try {
			name = getContext().getPackageManager().getPackageInfo(getContext().getPackageName(), 0).versionName;
		} catch (PackageManager.NameNotFoundException ex) {
			name = "";
		}
		return name;
	...
	public static void openApp(Context context, String packageName) {
		Intent mainIntent = getContext().getPackageManager().getLaunchIntentForPackage(packageName);
		if (mainIntent == null) {
