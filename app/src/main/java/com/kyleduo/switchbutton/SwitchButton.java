...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (ta != null) {
			...
			autoAdjustTextPosition = ta.getBoolean(R.styleable.SwitchButton_kswAutoAdjustTextPosition,
		...
		if (mTintColor == 0) {
			...
			boolean found = getContext().getTheme().resolveAttribute(R.color.uli_FF5449, typedValue, true);
			if (found) {
	...
	private void setup() {
		...
		if (mOnLayout != null) {
			float marginOnX = mBackRectF.left
					+ (mBackRectF.width() - mThumbRectF.width() - mThumbMargin.right - mOnLayout.getWidth()) / 2
		...
		if (mOffLayout != null) {
			float marginOffX = mBackRectF.right
					- (mBackRectF.width() - mThumbRectF.width() - mThumbMargin.left - mOffLayout.getWidth()) / 2
	...
	// setThumbDrawable(ContextCompat.getDrawable(getContext(),
	// thumbDrawableRes));
	// }
	...
	// setBackDrawable(ContextCompat.getDrawable(getContext(),
	// backDrawableRes));
	// }
	...
	// setBackColor(ContextCompat.getColorStateList(getContext(),
	// backColorRes));
	// }
	...
	// setThumbColor(ContextCompat.getColorStateList(getContext(),
	// thumbColorRes));
	// }
